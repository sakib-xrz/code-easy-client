      ...
      <div className="text-neutral px-6">
        <div className="container grid grid-cols-12 rounded-md mx-auto my-8 bg-zinc-100 drop-shadow-xl">
          ...
          <div className="flex flex-col col-span-12 lg:col-span-8 px-6 py-3">
            ...
            <p className="font-bold text-primary text-2xl mb-3 mt-2">
              ${price}
            </p>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="hidden lg:block">
                <Link
                  to={`/course/${id}`}
                  className="w-28 text-primary flex items-center justify-end"
                >
                  Learn More
                  <svg
            ...
            <div className="lg:hidden mb-2">
              <Link
                to={`/course/${id}`}
                className="w-28 text-primary flex items-center"
              >
                Learn More
                <svg
                  className="w-4 h-4 ml-2"
